...
class Event():
	...
	def __init__(self, client, ip_addr, message='', tag=None, reception_date=datetime.utcnow(), execution_date=None, end_date=None, step=0):
		"""
	...
	def from_dict(self,data):
		...
		"""
		attrs = ['client', 'message' ,'tag', 'ip_addr', 'reception_date', 'execution_date', 'end_date', 'step']
